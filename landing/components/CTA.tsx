    ...
    <section id="start" className="px-6 py-24">
      ...
      >
        ...
        <p className="mx-auto mt-5 max-w-lg text-white/70">
          No app to install. No portal logins. Just text your accountant — who happens to never sleep,
          never guesses, and counts to the exact paisa.
        </p>
        ...
        <p className="mt-6 font-mono text-[11px] uppercase tracking-widest text-white/40">
          Built on Claude Managed Agents · नेपालका लागि
        </p>
      </motion.div>
    </section>
  );
